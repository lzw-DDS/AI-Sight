...
- 📊 **提示词评分** — 多维度质量评估 + 雷达图可视化 + 优化建议
- 🌍 **世界观预设** — 丧尸末日/赛博朋克/废土等场景一键加载，自动带上下文
- 📋 **批量生成** — 多需求一次性处理，适合分镜脚本等批量场景
...
```
├── index.html          # 主界面（5 模式：生成/解析/转换/模板/批量）
...
│   ├── ai-provider.js  # AI 模型接入 + 评分系统
│   └── animation.js    # 动画效果
├── data/
│   ├── prompts.js      # 提示词模板库
│   ├── templates.js     # 官方工作流模板数据
│   └── presets.js      # 世界观预设（丧尸末日/赛博朋克/废土等）
└── README.md           # 本文档
```
